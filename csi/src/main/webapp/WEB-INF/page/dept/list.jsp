            ...
            <div class="col-md-6 col-md-offset-9">               
                <nav aria-label="Page navigation">                 
                    <ul class="pagination pagination-sm">                   
                        <li><a href="${ctx}/dept/list?pn=1">首页</a></li>
                        <c:if test="${pageInfo.hasPreviousPage }">
                            <li><a href="${ctx}/dept/list?pn=${pageInfo.pageNum-1}" aria-label="Previous">
                        ...
                        <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                            ...
                            <c:if test="${page_Num != pageInfo.pageNum }">
                                <li>
                                    <a href="${ctx}/dept/list?pn=${ page_Num}">${ page_Num}</a>
                                </li>
                            </c:if>
                        </c:forEach>
                        <c:if test="${pageInfo.hasNextPage }">
                            <li><a href="${ctx}/dept/list?pn=${pageInfo.pageNum+1}" aria-label="Next">
                                <span aria-hidden="true">&raquo;</span></a>
                            </li>
                        </c:if>
                        <li>
                            <a href="${ctx}/dept/list?pn=${pageInfo.pages}">末页</a>
                        </li>             
                    </ul>               
                </nav>       
            </div>
