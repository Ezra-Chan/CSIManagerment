           ...
           <!--  <td class="td-status">
			...
			<c:when test="${sessionScope.tip  == 1 }">
             ...
             <!--  <a onclick="member_stop(this,'10001')" href="javascript:;"  title="启用">
              ...
              <a title="编辑" onclick="x_admin_show('编辑','${ctx}/employee/add?id=${dept.id }');" href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
              </a>
                ...
                <nav aria-label="Page navigation">                 
                    <ul class="pagination pagination-sm">                   
                        ...
                        <c:if test="${pageInfo.hasPreviousPage }">
                            <li><a href="${ctx}/employee/list?pn=${pageInfo.pageNum-1}" aria-label="Previous">
                        ...
                        <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                            ...
                            <c:if test="${page_Num != pageInfo.pageNum }">
                                <li>
                                    <a href="${ctx}/employee/list?pn=${ page_Num}">${ page_Num}</a>
                                </li>
                            </c:if>
                        </c:forEach>
                        <c:if test="${pageInfo.hasNextPage }">
                            <li><a href="${ctx}/employee/list?pn=${pageInfo.pageNum+1}" aria-label="Next">
                                <span aria-hidden="true">&raquo;</span></a>
                            </li>
                        </c:if>
                        <li>
                            <a href="${ctx}/employee/list?pn=${pageInfo.pages}">末页</a>
                        </li>             
                    </ul>               
                </nav>       
            </div>
